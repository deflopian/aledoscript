...
(function ($, global) {
    ...
    DragScroll.prototype = {
        name: 'dragscroll',
        isTouchstartSupport: ("ontouchstart" in document) && !/firefox/i.test(navigator.userAgent)
    };

    $.extend(DragScroll.prototype, {
        events: {
            M_DOWN: DragScroll.prototype.isTouchstartSupport ? 'touchstart.' + DragScroll.prototype.name + ' ' + 'mousedown.' + DragScroll.prototype.name : 'mousedown.' + DragScroll.prototype.name,
            M_UP: DragScroll.prototype.isTouchstartSupport ? 'touchend.' + DragScroll.prototype.name + ' ' + 'mouseup.' + DragScroll.prototype.name : "mouseup." + DragScroll.prototype.name,
            M_MOVE: DragScroll.prototype.isTouchstartSupport ? 'touchmove.' + DragScroll.prototype.name + ' ' + 'mousemove.' + DragScroll.prototype.name : "mousemove." + DragScroll.prototype.name,
            ...
            RESIZE: 'orientationchange.' + DragScroll.prototype.name + ' ' + 'resize.' + DragScroll.prototype.name
        },
        ...
        */
        ...
        _buildIndex: function () {
            ...
            this.options.onRebuild.call(this.elem, this);
        },
        _bind: function () {
            var that = this;
            ...
            if (this.options.mouseWheelEnabled === true) {
        ...
        initMouseWheel: function (mode) {
            if (this.options.mouseWheelEnabled === false) return;
            if (mode === 'rebind') {
        ...
        _touchMoving: false,
        _pageXY: (function () {
            if (DragScroll.prototype.isTouchstartSupport) {
                return function (e) {
                    e.preventDefault();
        ...
        scrollToElement: function (el) {
            ...
            var sl = this.scrollElem[0].scrollLeft;
            this.scrollElem.scrollLeft(position.left + sl);
            this.setScrollbar();
        },
        /**
        * SCROLL START
